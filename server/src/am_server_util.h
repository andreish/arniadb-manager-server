...
int is_amserver_process (int pid, const char *module_name);
...
int ut_get_host_stat (T_AMS_HOST_STAT *stat, char *_dbmt_error);
int ut_get_proc_stat (T_AMS_PROC_STAT *stat, int pid);
