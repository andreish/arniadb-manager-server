...
#define DBMT_ARN_AMS_PID                "arn_manager.pid"
...
typedef enum
{
  AMS_TRAN_UNKNOWN_ISOLATION = 0x00,                 /*        0  0000 */
  AMS_TRAN_COMMIT_CLASS_UNCOMMIT_INSTANCE = 0x01,    /*        0  0001 */
  AMS_TRAN_DEGREE_1_CONSISTENCY = 0x01,              /* Alias of above */

  AMS_TRAN_COMMIT_CLASS_COMMIT_INSTANCE = 0x02,      /*        0  0010 */
  AMS_TRAN_DEGREE_2_CONSISTENCY = 0x02,              /* Alias of above */

  AMS_TRAN_REP_CLASS_UNCOMMIT_INSTANCE = 0x03,       /*        0  0011 */
  AMS_TRAN_READ_UNCOMMITTED = 0x03,                  /* Alias of above */

  AMS_TRAN_REP_CLASS_COMMIT_INSTANCE = 0x04,         /*        0  0100 */
  AMS_TRAN_READ_COMMITTED = 0x04,                    /* Alias of above */
  AMS_TRAN_CURSOR_STABILITY = 0x04,                  /* Alias of above */

  AMS_TRAN_REP_CLASS_REP_INSTANCE = 0x05,            /*        0  0101 */
  AMS_TRAN_REP_READ = 0x05,                          /* Alias of above */
  AMS_TRAN_DEGREE_2_9999_CONSISTENCY = 0x05,         /* Alias of above */

  AMS_TRAN_SERIALIZABLE = 0x06,                      /*        0  0110 */
  AMS_TRAN_DEGREE_3_CONSISTENCY = 0x06,              /* Alias of above */
  AMS_TRAN_NO_PHANTOM_READ = 0x06,                   /* Alias of above */

  AMS_TRAN_DEFAULT_ISOLATION = AMS_TRAN_REP_CLASS_UNCOMMIT_INSTANCE,

} AMS_DB_TRAN_ISOLATION;                             /* extract from dbi.h */
